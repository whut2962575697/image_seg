...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, radix=1, groups=1, bottleneck_width=64,
                 ...
                 last_gamma=False, norm_layer=nn.BatchNorm2d, first_conv_stride=2):
        self.cardinality = groups
        ...
        if deep_stem:
            self.conv1 = nn.Sequential(
                conv_layer(3, stem_width, kernel_size=3, stride=first_conv_stride, padding=1, bias=False, **conv_kwargs),
            ...
            self.conv1 = conv_layer(3, 64, kernel_size=7, stride=first_conv_stride, padding=3,
    ...
    def load_param(self, model_path):
        ...
        param_dict = {k[11:] : v for k, v in param_dict.items() if k.startswith('pretrained.')}
